...
let addChromeMessageEventHandlers = () =>{
    chrome.runtime.onMessage.addListener(
        function(request, sender, sendResponse) {
    
            if (request.type === chromeMessageTypes.DIFF_COLLAPSED){
            ...
            if (request.type === chromeMessageTypes.DIFF_CONDITION_DELETED) {
            ...
            if (request.type === chromeMessageTypes.DIFF_CONDITION_ADDED) {
                ga('send', 'event', {
                    eventCategory: 'File Diff Interaction',
            ...
            if (request.type === chromeMessageTypes.DIFF_CONDITION_UPDATED) {
            ...
            if (request.type === chromeMessageTypes.EXTERNAL_NAVIGATION_REQUESTED) {
            ...
            if (request.type === chromeMessageTypes.EXTENSION_UI_LOADED) {
...
export {initialize, addChromeMessageEventHandlers}